...
internals.BlockHeader.prototype.validateDifficulty = function (parentBlock) {
    ...
    return dif === utils.bufferToInt(this.header.difficulty);
};
...
internals.Block.prototype.validate = function (parentBlock) {
    ...
    return this.validateDifficulty(parentBlock) &&
        ...
        this.validatePOW() &&
        (utils.bufferToInt(this.header.timestamp) < utils.bufferToInt(parentBlock.header.timestamp)) &&
        (this.header.extraData.length < 1024);
};
